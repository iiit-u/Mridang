                ...
                <div className="border-t border-[#D5B37A]/20 pt-4">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-[#E7D3BA]/80">
                        ...
                        <p className="tracking-wide text-center sm:text-right">
                            Designed and developed by Shashank Sharma (CSE, 2027 Batch) and Rishabh Agarwal (ECE, 2027 Batch).
                        </p>
                    </div>
                </div>
            </div>
